...
COPY solution/cmd ./cmd/
COPY solution/internal ./internal/
COPY solution/pkg ./pkg/
COPY solution/platform ./platform/
COPY solution/migrations ./migrations/
