...
type Transaction struct {
	...
	MerchantID           *string              `json:"merchantId,omitempty" db:"merchant_id"`
	MerchantCategoryCode *MCCCode             `json:"merchantCategoryCode,omitempty" db:"merchant_category_code"`
	Timestamp            time.Time            `json:"timestamp" db:"timestamp"`
	IPAddress            *netip.Addr         `json:"ipAddress,omitempty" db:"ip_address"`
	...
	IsFraud              bool                 `json:"isFraud" db:"is_fraud"`
...
type TransactionCreateRequest struct {
	...
	MerchantCategoryCode *MCCCode             `json:"merchantCategoryCode,omitempty"`
	Timestamp            time.Time            `json:"timestamp"`
	IPAddress            *netip.Addr         `json:"ipAddress,omitempty"`
