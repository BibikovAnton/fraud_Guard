...
func (s *APIV1FraudRulesIDPutConflict) Encode(e *jx.Encoder) {
	unwrapped := (*ApiError)(s)
...
func (s *APIV1FraudRulesIDPutConflict) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode APIV1FraudRulesIDPutConflict to nil")
	}
	var unwrapped ApiError
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = APIV1FraudRulesIDPutConflict(unwrapped)
	return nil
}


func (s *APIV1FraudRulesIDPutConflict) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
func (s *APIV1FraudRulesIDPutConflict) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfFraudRuleEvaluationResult = [5]string{
	0: "ruleId",
	1: "ruleName",
	2: "priority",
	3: "matched",
