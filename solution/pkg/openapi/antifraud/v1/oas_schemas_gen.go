...
func (s *FraudRuleEvaluationResult) GetEnabled() bool {
	return s.Enabled
}
...
func (s *FraudRuleEvaluationResult) GetDescription() OptString {
	return s.Description
}
...
func (s *FraudRuleEvaluationResult) SetEnabled(val bool) {
	s.Enabled = val
}
...
func (s *FraudRuleEvaluationResult) SetDescription(val OptString) {
	s.Description = val
}
...
func (s *MerchantRiskRow) GetGmv() OptFloat64 {
	return s.Gmv
}
...
func (s *MerchantRiskRow) SetGmv(val OptFloat64) {
	s.Gmv = val
}
